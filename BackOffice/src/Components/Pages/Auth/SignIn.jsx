  ...
  return (
    <>
      <section
        ...
        style={{ backgroundImage: "url('src/assets/images/sign.avif')" }}
      >
        <div className="absolute inset-0 bg-black opacity-70"></div>{" "}
        {/* Superposition sombre */}
        <div className="flex justify-center items-center px-6 py-8 mx-auto h-full">
          <div
            className="bg-white rounded-lg shadow-md p-6 space-y-4 md:space-y-6 sm:p-8 z-10 relative"
            style={{ maxWidth: "500px", width: "100%" }}
          >
            <div className="logo flex justify-center items-center">
              {/* <FontAwesomeIcon icon={faPersonSnowboarding} className="text-3xl mr-2" style={{ color: 'navy' }}  /> */}
              <span className="font-bold text-2xl" style={{ color: "navy" }}>
                GO
              </span>
              <span
                className="font-bold text-2xl text-cons-light"
                style={{ color: "navy" }}
              >
                KO
              </span>
            ...
            <form className="space-y-4 md:space-y-6" onSubmit={handleSubmit}>
              <div>
                ...
                <div className="flex items-center border-2 border-gray-300 rounded-md">
                  <FontAwesomeIcon
                    icon={faEnvelope}
                    className="text-md mx-3 text-gray-600"
                  />
                  <input
                    type="email"
                    name="email"
