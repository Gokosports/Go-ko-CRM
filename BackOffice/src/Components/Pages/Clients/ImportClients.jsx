...
const ExcelImport = ({ onImportSuccess = () => {} }) => {
    ...
    const handleTransfer = () => {
        if (fileData) {
            ...
            const validData = fileData.filter(client => client.nom && client.prenom && client.email && client.phone && client.sex && client.address && client.age && client.type);
            ...
            axios.post('https://go-ko.onrender.com/clients/import', uniqueData, {
                ...
                .catch((error) => {
                    ...
                    message.error(`Erreur lors de l'importation des clients: ${errorMessage}`);
                });
        } else {
