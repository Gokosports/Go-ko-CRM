...
import { Breadcrumb, Table, Button, Modal, Form, Input, message, Tabs, Popconfirm } from 'antd';
        ...
        <div className="p-4 border rounded shadow-lg mt-4">
            ...
            <Tabs defaultActiveKey="2">
                ...
                {!isDoc()&&( 
                    ...
                    <Table
                        columns={columns}
                        dataSource={comments.filter(comment => comment && comment._id).map(comment => ({ ...comment, key: comment._id }))}
                        rowKey="_id"
                        className="mt-4"
